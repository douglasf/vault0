...
Tool outputs are snapshots, not live views. Always call \`vault0_task-view\` fresh before starting work — the task may have been edited, cancelled, or reassigned since you last saw it.
